       ...
       <ScrollWrapper>
         ...
         <ScrollContent>
           ...
           <div id="section-2" className="mb-20 lg:mb-40">
             ...
             <ul className="styled-list mb-8">
               <li>Image O2 Facial Lift Treatment</li>
               <li>Exfoliation</li>
               <li>Mask treatment</li>
             </ul>
             <p>*Steam & hot towels are used throughout entire treatment.</p>
           ...
           <div id="section-3" className="mb-20 lg:mb-40">
             ...
             <p>
               ...
               skin types. Choose between NeoBright for a lighting treatment for
               hyper-pigmentation or NewRevive for rejuvenating treatment for
           ...
           <div id="section-5" className="mb-20 lg:mb-40">
             ...
             <p>
               ...
               top layer of skin. The shave removes both dead skin cells and the
               fine vellus hairs that are known as “peach fuzz,” leaving the
               surface of the face ultra smooth. By stimulating the development
               of new skin cells, this type of exfoliation helps new skin rise
               to the surface. It leaves clients with a more youthful and dewy
               face without any harsh chemicals, excessive downtime, or pain.
             </p>

             <p className="text-small font-medium tracking-wide text-gray-900">
               $130 (60 Minutes)
             </p>
             <p>Add Dermaplane to Signature Facial Add-on +$70</p>
           </div>
           ...
           <div id="section-6" className="mb-20 lg:mb-40">
             ...
             <p>
               ...
               utilizes all-natural Dr. Schwab products. Benefits include
               getting rid of back acne, reducing oiliness, and softening the
               skin and an overall soothing experience. Consider adding on our
               Mini Facial to experience 60 minutes of relaxation.
             </p>
             <p className="text-small font-medium tracking-wide text-gray-900">
               $75 (30 Minutes)
             </p>
           ...
           <div className="block w-full text-center">
             <p className="heading-two">Facial Add-ons</p>
           </div>
           <div id="section-10">
             <span className="text-xs text-gray-900 font-bold tracking-widest block mb-6 lg:mb-8">
               10
             ...
             <div className="mb-20 lg:mb-40">
               ...
               <p>
                 Powerful Line Remover and Collagen Booster. Liquid Face Lift in
                 a Bottle. Our potent serum signals your skin to increase
               ...
               <ul className="styled-list">
                 <li>
                   Increases collagen production with potent Matrixyl 3000,
