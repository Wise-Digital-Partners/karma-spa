                  ...
                  <div className="md:col-end-13 md:col-span-5 bg-white pt-6 pb-8 md:py-16 px-6 md:px-16 flex items-center">
                     <div>
                        ...
                        <p className="mb-4 md:mb-12">
                           Call:{" "}
                           <a className="gtm-phone-number" href="tel:+1-619-299-9888">
                              619-299-9888
                           </a>{" "}
                           <br /> Text:{" "}
                           <a className="gtm-phone-number" href="sms:+1-619-916-1608">
                              619-916-1608
                           </a>
                        </p>
               ...
               <div className="grid grid-cols-1 md:grid-cols-12 shadow-xl">
                  ...
                  <div className="md:col-end-13 md:col-span-5 bg-white pt-6 pb-8 md:py-16 px-6 md:px-16 flex items-center">
                     <div>
                        ...
                        <p className="mb-4 md:mb-12">
                           Call:{" "}
                           <a className="gtm-phone-number" href="tel:+1-760-729-9888">
                              760-729-9888
                           </a>{" "}
                           <br /> Text:{" "}
                           <a className="gtm-phone-number" href="sms:+1-760-729-9889">
                              760-729-9889
                           </a>
                        </p>
