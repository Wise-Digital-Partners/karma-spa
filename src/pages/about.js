...
export const Page = ({data}) => {
  ...
  return (
    ...
    >
    	<h1>About Us</h1>
    	<p className="mb-0">Our mission is your relaxation. At Karma Spa, we offer “Affordable Indulgence” at our two massage spa locations in Hillcrest and Carlsbad. We offer a wide variety of services and packages to bring you great value and refreshment.</p>
    </HeroSplit>
