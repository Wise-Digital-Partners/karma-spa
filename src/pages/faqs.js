	...
	return (
		...
		<section className="pt-10 md:pt-8 pb-12 md:pb-0 bg-gray-100 md:bg-transparent">
			<div className="container">
				<div className="grid grid-cols-1 md:grid-cols-12 row-gap-8 md:row-gap-0 ">
					...
					<Accordion
						...
						content="<p>We recommend 15%-20% of the service price.</p>"
					/>	
					<Accordion
					...
					/>
					<Accordion
						title="Do you have parking at both locations?"
						content="<p>Yes, parking is available.</p>"
					/>
					<Accordion
