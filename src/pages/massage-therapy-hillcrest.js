    ...
    <Layout>
      ...
      >
        ...
        <p className="mb-2 md:mb-0">
          ...
          indulgence awaits with our Hillcrest massage therapy services.
        </p>
      </HeroSplit>
      ...
      <ScrollWrapper>
        <ScrollNavigation>
          ...
          <li>
            <AnchorLink to={url + "#section-17"} title="Foot Massage" stripHash />
          </li>
          <li>
        ...
        <ScrollContent>
          ...
          <div id="section-2" className="mb-20 lg:mb-40">
            ...
            <p className="text-xl font-heading text-[#1A1A1A] my-6">Too much computer?</p>
            <p>
          ...
          <div id="section-3" className="mb-20 lg:mb-40">
            ...
            <p>
              “Chair” means clothes on and is done in a foot massage room or performed in a chair.
            </p>
            <p className="text-small font-medium tracking-wide text-gray-900">
              $50 (30 Minutes)
              <br className="block lg:hidden" />
              ...
              <br />
              <br className="block lg:hidden" />
              Neck & Shoulder: <br className="block lg:hidden" />
              $35 (15 Minutes)
              <br />
              <br className="block lg:hidden" />
              Hands & Arms: <br className="block lg:hidden" />
              $35 (20 Minutes)
            </p>
          </div>
          ...
          <div id="section-9" className="mb-20 lg:mb-40">
            ...
            <p className="text-xl font-heading text-[#1A1A1A] my-6">Perfect for athletes!</p>
            <p>
          ...
          <div id="section-10" className="mb-20 lg:mb-40">
            ...
            <h3>Thai Massage</h3>
            <p className="text-xl font-heading text-[#1A1A1A] my-6">Yoga without the work!</p>
            <p>
          ...
          <div id="section-11" className="mb-20 lg:mb-40">
            ...
            <p className="text-xl font-heading text-[#1A1A1A] my-6">Our most popular modality!</p>
          ...
          <div id="section-13" className="mb-20 lg:mb-40">
            ...
            <p className="text-xl font-heading text-[#1A1A1A] my-6">Two therapists, four hands!</p>
            <p>
          ...
          <div id="section-15" className="mb-20 lg:mb-40">
            ...
            <p className="text-xl font-heading text-[#1A1A1A] my-6">Relax from head to toe!</p>
            <p>
            ...
            <p className="text-small font-medium tracking-wide text-gray-900">
              ...
              <br />
              <br className="block lg:hidden" />
              Foot Massage Only: <br className="block lg:hidden" />
              $50 (30 Minutes)
              <br />
              <br className="block lg:hidden" />
          ...
          <div id="section-16" className="mb-20 lg:mb-40">
            ...
            <p>
              Eucalyptus or lavender infused oil conditions the skin, making it supple and soft. Not
              only does this help you feel better and more relaxed during and after the massage, but
              it can also help with skin conditions such as eczema, acne, psoriasis, or even just
              dry skin.
            </p>
            <p className="text-small font-medium tracking-wide text-gray-900">
              $90 (60 Minutes)
          ...
          <div id="section-18" className="mb-20 lg:mb-40">
            ...
            <div className="mb-12 lg:mb-24">
              ...
              <p className="text-small font-medium tracking-wide text-gray-900">
                ...
                <br />
                • Deep Tissue Add-on +$5 (Ex: 60 Minute Couple’s Swedish Massage)
                <br />
                • Air Cupping Add-on +$15
                <br />
              </p>
            </div>
