      ...
      >
        <div className="max-w-4xl m-auto text-center">
          ...
          <div className="grid grid-cols-2 col-gap-4 md:col-gap-8 max-w-sm mx-auto">
            <ButtonSolid className="is-light w-full md:w-auto" href="https://go.booker.com/location/karmaspa/service-menu"target="_blank" rel="noopener noreferrer" text="Hillcrest"/>
            <ButtonSolid className="is-light w-full md:w-auto" href="https://go.booker.com/location/karmarelaxationspa2/service-menu"target="_blank" rel="noopener" text="Carlsbad"/>
          </div>
        </div>
      </HeroAlignEnd>
