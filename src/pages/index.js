...
import WeeklySpecials from "../components/Repeating/WeeklySpecials";
    ...
    <Layout headerStyle="overlap" headerLinkColor="white" headerHasBorder={true}>
      ...
      >
        <div className="max-w-4xl m-auto text-center">
          <p className="text-white font-heading text-mobile7xl md:text-7xl leading-tight font-semibold mb-4">
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-y-20 md:gap-y-0">
            <div className="md:col-start-1 md:col-end-7 md:pr-16">
              ...
              <p>
                Ready to relax? See why Karma Spa is one of the best massage spas in San Diego. We
                offer over a dozen massage styles to suit your tastes. But massage is just the
                beginning. Make the most of our day spas with quality skin care services (Carlsbad)
                and IV hydration (Hillcrest) —or save money with a package that pampers you in
                style. Book your appointment at our Hillcrest or Carlsbad location today!
              </p>
