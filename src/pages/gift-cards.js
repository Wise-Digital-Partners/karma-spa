...
export default class Page extends Component {
   ...
   handleChange(value) {
      ...
      if (value === "Hillcrest") {
         ...
         giftCardUrl = "https://www.secure-booker.com/karmarelaxationspa2/ShopOnline/GiftCertificate.aspx";
      }
   }
      ...
      return (
         <Layout headerLinkColor="black">
            ...
            >
               <h1>Gift Cards</h1>
               <p>
                  Give the gift of affordable indulgence with our gift cards! They’re available for purchase online and in-store. Start with your
                  preferred location below.
               </p>
               <RadioGroup className="mb-8" name="location" selectedValue={this.state.selectedValue} onChange={this.handleChange}>
