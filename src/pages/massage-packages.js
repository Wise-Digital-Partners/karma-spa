      ...
      <Layout headerStyle="overlap" headerLinkColor="black" headerHasBorder={false}>
         ...
         >
            ...
            <p className="mb-2 md:mb-0">
               ...
               will pamper you properly when you need it most. Our Hillcrest and Carlsbad massage spas are ready to deliver.
            </p>
         </HeroSplit>
         ...
         <ScrollWrapper>
            <ScrollNavigation>
               <li>
                  <AnchorLink to="/massage-packages/#section-1" title="The Premier Package" stripHash />
               </li>
               <li>
                  <AnchorLink to="/massage-packages/#section-2" title="The Royal Package" stripHash />
               </li>
               <li>
                  <AnchorLink to="/massage-packages/#section-3" title="The President Package" stripHash />
               </li>
               <li>
                  <AnchorLink to="/massage-packages/#section-4" title="The First Lady Package" stripHash />
               </li>
               <li>
                  <AnchorLink to="/massage-packages/#section-5" title="The Duchess Package" stripHash />
               </li>
               <li>
                  <AnchorLink to="/massage-packages/#section-6" title="The Princess Package" stripHash />
               </li>
               <li>
                  <AnchorLink to="/massage-packages/#section-7" title="The CEO Package" stripHash />
               </li>
               <li>
                  <AnchorLink to="/massage-packages/#section-8" title="The Vice President Package" stripHash />
               </li>
               <li>
                  <AnchorLink to="/massage-packages/#section-9" title="The Doctor Package" stripHash />
               </li>
               <li>
                  <AnchorLink to="/massage-packages/#section-10" title="The Director Package" stripHash />
               </li>
               <li>
                  <AnchorLink to="/massage-packages/#section-11" title="The Runners’ Package" stripHash />
               </li>
               <li>
                  <AnchorLink to="/massage-packages/#section-12" title="The Secretary Package" stripHash />
               </li>
            </ScrollNavigation>
            <ScrollContent>
               ...
               <div id="section-3" className="mb-20 lg:mb-40">
                  <span className="inline-flex items-center bg-white rounded text-gray-900 text-lg font-medium px-3 py-2 mb-8">
                     <i class="fas fa-tag text-primary_400 mr-2"></i> $145
                  </span>
               ...
               <div id="section-5" className="mb-20 lg:mb-40">
                  ...
                  <p className="font-heading text-2xlarge font-light text-gray-900 mb-8">
                     Hydrate and detoxify your entire body with this lush package.
                  </p>
                  <ul className="styled-list mb-8">
               ...
               <div id="section-11" className="mb-20 lg:mb-40">
                  ...
                  <p className="font-heading text-2xlarge font-light text-gray-900 mb-8">
                     Recover well and run better with this package tailored just for runners.
                  </p>
                  <ul className="styled-list mb-8">
               ...
               <div id="section-12">
                  <span className="inline-flex items-center bg-white rounded text-gray-900 text-lg font-medium px-3 py-2 mb-8">
                     <i class="fas fa-tag text-primary_400 mr-2"></i> $50
                  </span>
                  <h3 className="mb-1">The Secretary Package</h3>
                  <p className="font-heading text-2xlarge font-light text-gray-900 mb-8">
                     Treat yourself and take a break after long hours at the desk.{" "}
                  </p>
                  <ul className="styled-list mb-8">
