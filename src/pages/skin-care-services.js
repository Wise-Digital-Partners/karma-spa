      ...
      <Layout headerStyle="overlap" headerLinkColor="black" headerHasBorder={false}>
         ...
         >
            ...
            <p className="mb-2 md:mb-0">
               ...
               Find the right service for your needs today, whether it’s a facial, waxing session, scrubs, or sauna session.
            </p>
         </HeroSplit>
         ...
         <ScrollWrapper>
            <ScrollNavigation>
               <li>
                  <AnchorLink to="/skin-care-services/#section-1" title="Signature Facial" stripHash />
               </li>
               <li>
                  <AnchorLink to="/skin-care-services/#section-2" title="O2 Facial" stripHash />
               </li>
               <li>
                  <AnchorLink to="/skin-care-services/#section-3" title="Oxygen Facial" stripHash />
               </li>
               <li>
                  <AnchorLink to="/skin-care-services/#section-4" title="HydraFacial" stripHash />
               </li>
               <li>
                  <AnchorLink to="/skin-care-services/#section-5" title="Back Facial" stripHash />
               </li>
               <li>
                  <AnchorLink to="/skin-care-services/#section-6" title="Mini Facial" stripHash />
               </li>
               <li>
                  <AnchorLink to="/skin-care-services/#section-7" title="Clarity & Led Therapy (Hillcrest only)" stripHash />
               </li>
               <li>
                  <AnchorLink to="/skin-care-services/#section-8" title="Customized Facial (Hillcrest only)" stripHash />
               </li>
               <li>
                  <AnchorLink to="/skin-care-services/#section-9" title="Gentleman’s Facial" stripHash />
               </li>
               <li>
                  <AnchorLink to="/skin-care-services/#section-10" title="Waxing" stripHash />
               </li>
               <li>
                  <AnchorLink to="/skin-care-services/#section-11" title="Steam Room (Hillcrest Only)" stripHash />
               </li>
               <li>
                  <AnchorLink to="/skin-care-services/#section-12" title="Facial Add-ons" stripHash />
               </li>
            </ScrollNavigation>
            <ScrollContent>
               ...
               <div id="section-5" className="mb-20 lg:mb-40">
                  ...
                  <h3>Back Facial</h3>
                  <p>
                     We’ve got your back! Benefit from our signature back facial that utilizes all-natural Dr. Schwab Products. Benefits include
                     getting rid of back acne, reducing oiliness, and softening the skin and an overall soothing experience.
                  </p>
