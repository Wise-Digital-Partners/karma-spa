...
export const Page = ({data}) => {
  ...
  return (
    ...
    >
      ...
      <ScrollWrapper>
		<ScrollNavigation>
			<li><AnchorLink to="/skin-care-services/#section-1" title="Signature Facial" stripHash /></li>
			...
			<li><AnchorLink to="/skin-care-services/#section-6" title="Mini Facial" stripHash /></li>
			<li><AnchorLink to="/skin-care-services/#section-7" title="Clarity & Led Therapy (Hillcrest only)" stripHash /></li>
			<li><AnchorLink to="/skin-care-services/#section-8" title="Customized Facial (Hillcrest only)" stripHash /></li>
			<li><AnchorLink to="/skin-care-services/#section-9" title="Gentleman’s Facial" stripHash /></li>			
			<li><AnchorLink to="/skin-care-services/#section-10" title="Waxing" stripHash /></li>
			<li><AnchorLink to="/skin-care-services/#section-11" title="Steam Room (Hillcrest Only)" stripHash /></li>
		...
		<ScrollContent>
			<div id="section-1" className="mb-20 lg:mb-40">
				...
				<p>Our Signature Facial is customizable to all skin types. It promotes a clear, well-hydrated complexion utilizing all-natural Dr. Schwab products. </p>
				...
				<p className="text-small font-medium tracking-wide text-gray-900">Add ons: <b>Pumpkin Peel Mask</b> (+$20). Stubborn acne? Add on <b>High Frequency</b> (+$15).</p>
			...
			<div id="section-3" className="mb-20 lg:mb-40">
				...
				<h3>Oxygen Facial</h3>
				<p>Experience deep exfoliation without the downtime of a chemical peel! This exfoliating facial is <b>not recommended for sensitive skin</b>. Choose between NeoBright for a lighting treatment for hyper-pigmentation or NewRevive for rejuvenating treatment for fine lines and wrinkles.</p>
				...
				<p className="text-small font-medium tracking-wide text-gray-900"><b>NeoBright active ingredients</b><br/>
				Azelaic Acid: Evens out skin tone • Kojic Acid: Brightens • Retinol: Anti-aging
				</p>

				<p className="text-small font-medium tracking-wide text-gray-900"><b>NeoRevive active ingredients</b><br/>
			...
			<div id="section-4" className="mb-20 lg:mb-40">
				...
				<p>*Steam & hot towels are used throughout entire treatment</p>
				<p className="text-small font-medium tracking-wide text-gray-900">Price: $145 (60 Minutes)</p>
			</div>  
			...
			<div id="section-5" className="mb-20 lg:mb-40">
				...
				<h3>Back Facial</h3>
				<p>We’ve got your back! Benefit from our signature back facial that utilizes all-natural Dr. Schwab Products. Benefits include getting rid of back acne, reducing oiliness, and softening the skin and an overall soothing experience.</p>
				<p>Consider adding on our Mini Facial to experience 60 minutes of relaxation.</p>
			...
			<div id="section-6" className="mb-20 lg:mb-40">
				...
				<h3>Mini Facial</h3>
				<p>A mini facial treatment is an abbreviated version of our signature facial treatment. Typically provided in 30 minutes, it’s short enough to complete during a lunch break but long enough to feel luxurious.</p>
				<p className="mb-3">Includes:</p>
				<ul className="styled-list mb-8">
					<li>Skin analysis</li>
					<li>Cleanse</li>
			...
			<div id="section-9" className="mb-20 lg:mb-40">
				...
				<p>Men need pampering too! This relaxing treatment helps repair the damage caused by daily shaving, skin sensitivity, dullness, and aging.</p>
				<p className="mb-3">Includes:</p>
				<ul className="styled-list mb-8">
					<li>Skin analysis</li>
					<li>Cleanse</li>
			...
			<div id="section-10" className="mb-20 lg:mb-40">
				...
				<p className="text-small font-medium tracking-wide text-gray-900">
					Brow: $15<br className="block lg:hidden" /><span className="hidden lg:inline lg:mx-1">•</span>
					Nose: $10<br className="block lg:hidden" /><span className="hidden lg:inline lg:mx-1">•</span>
					Upper Lip: $12<br className="block lg:hidden" /><span className="hidden lg:inline lg:mx-1">•</span>
					Full Face: $50<br className="block lg:hidden" /><span className="hidden lg:inline lg:mx-1">•</span>
					Underarm: $25<br className="block lg:hidden" /><span className="hidden lg:inline lg:mx-1">•</span>
					Half Arm: $30<br className="block lg:hidden" /><span className="hidden lg:inline lg:mx-1">•</span>
					...
					Brazilian Wax: $60 (Includes back strip; trimming: add $10)<br className="block lg:hidden" /><span className="hidden lg:inline lg:mx-1">•</span>
			...
			<div id="section-11" className="mb-20 lg:mb-40">
				...
				<h3>Steam Room (Hillcrest Only)*</h3>
				...
				<p>*Carlsbad location only has a sauna.</p>
				<p className="text-small font-medium tracking-wide text-gray-900">
					Price: $11 (15 Minutes) • $21 (30 Minutes) • $31 (60 Minutes)
				</p>
			</div>
			<div id="section-12">
				...
				<div className="mb-20 lg:mb-40">
					...
					<p>This add-on helps drive highly refined extracted ingredients that have been added to (h2t) Pumpkin Peel (anti-oxidants, vitamins & nutrients) into the skin.</p>
				...
				<div className="mb-20 lg:mb-40">
					...
					<p>Treat and prevent stubborn acne, shrink enlarged pores, reduce inflammation, and decongest puffy eyes. The primary action of high-frequency current is thermal (heat producing) and oxygen. Add to any facial.</p>
					<p className="mb-3">Benefits:</p>
					<ul className="styled-list mb-8">
