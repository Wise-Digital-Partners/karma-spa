     ...
     <Layout>
       ...
       >
         ...
         <p className="mb-2 md:mb-0">
           ...
           Find the right service for your needs in Hillcrest today, whether
           it’s a facial, waxing session, scrubs, or sauna session.
         </p>
       </HeroSplit>
         ...
         <ScrollContent>
           ...
           <div id="section-2" className="mb-20 lg:mb-40">
             ...
             <p>
               ...
               non-invasive, and non-irritating because there are no incisions
               or punctures to the skin.
             </p>
             <p className="font-heading text-2xlarge font-light text-gray-900 mb-1">
               Includes:
             </p>
           ...
           <div id="section-3" className="mb-20 lg:mb-40">
             ...
             <p>
               ...
               top layer of skin without any harsh chemicals, excessive
               downtime, or pain.
             </p>
             <p className="font-heading text-2xlarge font-light text-gray-900 mb-1">
               Includes:
