         ...
         <section className="wrapper mt-12 md:mt-32">
            <div className="container">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 md:gap-y-0 md:gap-x-16">
                  <div>
                     <p className="mb-0">
                        Ready for deep relaxation? Karma Spa’s massage therapists specialize in San Diego deep tissue massage. We combine firm
                        pressure and slow strokes to reach deeper layers of muscle and tissue in your body. This helps ease tension and reduce pain
                        and inflammation.
                     </p>
                  </div>
                  <div>
                     <p className="mb-0">
                        Deep tissue massage therapy is particularly helpful for chronic aches and pains. If you have a stiff neck and upper back, low
                        back pain, leg muscle tightness, or sore shoulders—and if you’re not a massage first-timer—this is the massage for you.
                     </p>
                  </div>
               </div>
            </div>
            ...
            <div className="container">
               <div className="grid grid-cols-1 md:grid-cols-12 gap-y-8 md:gap-y-0 items-center">
                  ...
                  <div className="md:col-end-13 md:col-span-4">
                     ...
                     <p className="mb-0">
                        When booking an appointment, you’ll be able to choose between a male or female therapist. We’ll make sure the amount of
                        pressure applied to your body is what you’re looking for too.
                     </p>
                  </div>
               </div>
            </div>
            ...
            <div className="container">
               <div className="pb-12 md:py-20 md:border-t border-b border-solid border-gray-200 border-opacity-50">
                  <header className="text-center max-w-2xl mx-auto">
                     ...
                     <h3>Fun Fact</h3>
                     <p className="mb-0">
                        Research studies confirm that deep tissue massage has helped those with plantar fasciitis, fibromyalgia, and chronic tension
                        headaches.
                     </p>
                  </header>
               </div>
