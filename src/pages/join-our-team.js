  ...
  return (
    ...
    >
		...
		<section className="wrapper mt-12 md:mt-32">
			...
			<div className="grid grid-cols-1 md:grid-cols-12 row-gap-16 md:row-gap-0 md:col-gap-24 text-center">
				<div className="md:col-start-1 md:col-span-6">
					...
					<p className="mb-0">Our employees deserve the best care. When you start your career here, you get the opportunity to experience complimentary massages from our esteemed expert therapists.</p>
				</div>
				<div className="md:col-end-13 md:col-span-6">
					...
					<p className="mb-0">Want to make someone’s day? Tired of typical customer service jobs? Here, every customer you help is guaranteed total relaxation and peace of mind. Be part of their healing process.</p>
				</div>
			</div>
			</div>
		</section>
