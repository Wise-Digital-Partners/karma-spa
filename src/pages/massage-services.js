  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="mb-2 md:mb-0">Relax. Reduce pain and stress. Improve circulation and flexibility. Prevent injury and facilitate healing. Massage has many benefits, and we have many options. Your next indulgence awaits with our Hillcrest and Carlsbad massage services.</p>
      </HeroSplit>
		...
		<ScrollContent>
			<div id="section-1" className="mb-20 lg:mb-40">
				...
				<p className="text-small font-medium tracking-wide text-gray-900">
					...
					$90 (90 Minutes)<br className="block lg:hidden" /><span className="hidden lg:inline lg:mx-1">•</span>
					$120 (2 Hours)
				</p>
			...
			<div id="section-2" className="mb-20 lg:mb-40">
				...
				<p className="text-small font-medium tracking-wide text-gray-900">
					$120 (60 Minutes)<br className="block lg:hidden" /><span className="hidden lg:inline lg:mx-1">•</span>
			...
			<div id="section-12" className="mb-20 lg:mb-40">
				...
				<p className="text-small font-medium tracking-wide text-gray-900">
					$120 (1 Hour)<br className="block lg:hidden" /><span className="hidden lg:inline lg:mx-1">•</span>
					$180 (90 Minutes)<br className="block lg:hidden" /><span className="hidden lg:inline lg:mx-1">•</span>
					$240 (2 Hours)
				</p>
			</div> 
			...
			<div id="section-14" className="mb-20 lg:mb-40">
				...
				<p className="text-small font-medium tracking-wide text-gray-900">
					...
					$90 (2 Hours)  Add foot scrub for only $20.<br/><br className="block lg:hidden" />
					Prenatal: <br className="block lg:hidden" />
					$55 (60 Minutes)<br className="block lg:hidden" /><span className="hidden lg:inline lg:mx-1">•</span>
					$75 (90 Minutes)<br className="block lg:hidden" /><span className="hidden lg:inline lg:mx-1">•</span>
					$95 (2 Hours)
				</p>
			</div> 
