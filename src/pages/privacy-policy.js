...
const Page = () => {
  return (
    <Layout>
      <div id="section-1" className="container mt-20 mb-20 lg:mb-40 privacy-policy">
        <h1>Privacy Policy</h1>
        <p>
          Protecting your private information is our priority. This Statement of Privacy applies to
          https://www.karmamassagespa.com and Karma Spa and governs data collection and usage. For
          the purposes of this Privacy Policy, unless otherwise noted, all references to Karma Spa
          include https://www.karmamassagespa.com. The Karma Spa website is a general informational
          site. By using the Karma Spa website, you consent to the data practices described in this
          statement.
        </p>
        <h2>Collection of your Personal Information</h2>
        <p>
          In order to better provide you with products and services offered, Karma Spa may collect
        ...
        <p>
          ...
          signing up for special offers from selected third parties; (d) sending us an email
        ...
        <p>
          Karma Spa collects and uses your personal information to operate and deliver the services
          you have requested.
        </p>
        <p>
          Karma Spa may also use your personally identifiable information to inform you of other
          products or services available from Karma Spa and its affiliates.
        </p>
        <h2>Sharing Information with Third Parties</h2>
        <p>Karma Spa does not sell, rent or lease its customer lists to third parties.</p>
        <p>
          Karma Spa may share data with trusted partners to help perform statistical analysis, send
          ...
          services to Karma Spa, and they are required to maintain the confidentiality of your
          information.
        </p>
        <p>
          Karma Spa may disclose your personal information, without notice, if required to do so by
          law or in the good faith belief that such action is necessary to: (a) conform to the
          edicts of the law or comply with legal process served on Karma Spa or the site; (b)
          protect and defend the rights or property of Karma Spa; and/or (c) act under exigent
          circumstances to protect the personal safety of users of Karma Spa, or the public.
        </p>
        <h2>Automatically Collected Information</h2>
        <p>
          Information about your computer hardware and software may be automatically collected by
          Karma Spa. This information can include: your IP address, browser type, domain names,
          ...
          regarding use of the Karma Spa website.
        </p>
        <h2>Use of Cookies</h2>
        <p>
          The Karma Spa website may use "cookies" to help you personalize your online experience. A
        ...
        <p>
          ...
          specific page. For example, if you personalize Karma Spa pages, or register with Karma Spa
          site or services, a cookie helps Karma Spa to recall your specific information on
          ...
          Karma Spa website, the information you previously provided can be retrieved, so you can
          easily use the Karma Spa features that you customized.
        </p>
        <p>
          ...
          features of the Karma Spa services or websites you visit.
        </p>
        <h2>Links</h2>
        <p>
        ...
        <p>
          Karma Spa does not knowingly collect personally identifiable information from children
        ...
        <p>
          From time to time, Karma Spa may contact you via email for the purpose of providing
          ...
          open an email from Karma Spa or click on a link therein.
        </p>
        <p>
          If you would like to stop receiving marketing or promotional communications via email from
          Karma Spa, you may opt out of such communications by clicking on the UNSUBSCRIBE button.
        </p>
        <h2>Changes to this Statement</h2>
        <p>
          Karma Spa reserves the right to change this Privacy Policy from time to time. We will
        ...
        <p>
          Karma Spa welcomes your questions or comments regarding this Statement of Privacy. If you
          believe that Karma Spa has not adhered to this Statement, please contact Karma Spa at:
        </p>
        <p>
          Email Address: <a href="mailto:relax@karmamassagespa.com">relax@karmamassagespa.com</a>
        </p>
