...
export const Page = ({ data }) => {
   ...
   return (
      <Layout headerStyle="classic" headerLinkColor="black" headerHasBorder={false}>
         ...
         >
            <h1>
               Botox & <br className="hidden md:block" /> Facial Fillers
            </h1>
            <p className="mb-0">
               Restore a more youthful look and rejuvenate your skin with neuromodulators and facial fillers. Our licensed aesthetic medicine team
               uses only safe and FDA-approved products for great results. Schedule your free consultation today!{" "}
            </p>
         </HeroSplit>
            ...
            <div className="container">
               <div className="grid grid-cols-1 md:grid-cols-12 gap-y-6 md:gap-y-0 items-center">
                  ...
                  <div className="md:col-end-13 md:col-span-4">
                     ...
                     <p className="mb-0">
                        Rejuvenate your skin with neuromodulators and facial fillers. Our licensed aesthetic medicine team uses only safe and
                        FDA-approved products for great results. At Karma Bella, our team provides high-quality aesthetic medicine services to enhance
                        our clients’ natural beauty. For the latest in anti-aging, look no further than Karma Bella.
                     </p>
                  </div>
               </div>
            </div>
         ...
         <section className="wrapper">
            <div className="container">
               <header className="text-center max-w-2xl mx-auto mb-12 md:mb-20">
                  <h3>Botox Facts</h3>
                  <p className="mb-0">
                     Botulinum toxin (or botox) is a type of protein which, when used in small amounts, temporarily reduces wrinkles. Learn more about
                     its benefits below!
                  </p>
               </header>
               <div className="grid grid-cols-1 md:grid-cols-3 gap-y-10 md:gap-y-0 md:gap-x-20 text-center md:text-left">
                  <div>
                  ...
                  <div>
                     ...
                     <p className="mb-0">
                        One non-aesthetic benefit of botox is blocking neurotransmitters that the brain associates with migraine pain.
                     </p>
                  </div>
               </div>
            </div>
         ...
         <section className="bg-gray-100 pt-20 md:pt-40 pb-44 md:pb-64">
            <div className="container">
               <header className="md:mb-18">
                  <h2>Meet the Team</h2>
                  <p className="font-heading text-xlarge md:text-2xl text-gray-900">
                     Get to know the dedicated and professional team behind Karma Bella!
                  </p>
               </header>
               <SliderTeamMembers />
            </div>
         ...
         <section className="bg-gray-100 pb-20 md:pb-36">
            <div className="container">
               <div className="bg-white md:shadow-xl px-6 md:px-20 py-18 md:py-32 -mx-6 md:mx-0">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-12 md:gap-x-6 mb-14 md:mb-24">
                     <div className="md:col-start-1 md:col-span-4">
                        <h2>Botox</h2>
                     </div>
                     <div className="md:col-end-13 md:col-span-8">
                        <p>
                           Botox, Xeomin and Dysport are excellent options for men and women who want to be proactive in the anti-aging process.
                           Neuromodulators relax muscles to prevent and smooth crow’s feet, forehead wrinkles and fine lip lines. Neuromodulators are
                           also used for non-surgical brow lifts and can lessen TMJ.
                        </p>
                        <p className="text-small text-gray-900 mb-0">
                           Botox: $10.99/unit
                           <br />
                           Xeomin: $10.99/unit
                           <br />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-12 md:gap-x-6">
                     ...
                     <div className="md:col-end-13 md:col-span-8">
                        <p>
                           We carry FDA-approved products Restylane, Juvéderm, Beloterro, and Radiesse) for both men and women interested in restoring
                           and preserving a youthful complexion. Fillers replace volume to address fine lines around lips, circles under the eyes,
                           laugh lines and increases fullness of the lips, cheeks and temporal areas and last 6 months to 2 years depending on the
                           area treated.
                        </p>
