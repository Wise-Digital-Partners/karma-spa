                ...
                <div className="modal relative hidden z-50" id="modal-membership" aria-hidden="false"> 
                    <div className="overlay fixed flex items-center justify-center top-0 right-0 left-0 bottom-0 bg-black bg-opacity-75 outline-none" tabIndex="-1" data-modal-close>
                        <div className="content-wrapper bg-white max-w-2xl mx-6 w-full overflow-auto py-16 md:py-28 px-6" role="dialog" aria-modal="true">
                            ...
                            <div className="grid grid-cols-2 col-gap-4 md:col-gap-8 justify-center mt-12 max-w-sm mx-auto">
                                <ButtonSolid className="w-full md:w-auto" href="https://www.secure-booker.com/karmaspa/ShopOnline/Membership.aspx"target="_blank" rel="noopener noreferrer" text="Hillcrest" />
                                <ButtonSolid className="w-full md:w-auto" href="https://www.secure-booker.com/karmarelaxationspa2/ShopOnline/Membership.aspx"target="_blank" rel="noopener noreferrer" text="Carlsbad" />
                            </div>
