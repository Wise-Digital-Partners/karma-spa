...
const Modal = () => {
    ...
    return (
        <div>
            <StyledModal>
                <div className="modal relative hidden z-40" id="modal-carlsbad" aria-hidden="false"> 
                    <div className="overlay fixed flex items-center justify-center top-0 right-0 left-0 bottom-0 bg-black bg-opacity-75 outline-none" tabIndex="-1" data-modal-close>
                        <div className="content-wrapper bg-gray-100 w-full h-screen overflow-auto max-w-3xl ml-auto py-20 px-6 md:px-20" role="dialog" aria-modal="true">
