...
const StyledSlider = styled.div`
   ...
   .slick-list {
      @media (min-width: 768px) {
         ...
         &:before {
            content: "";
            ${tw`absolute left-0 h-full w-full transform -translate-x-full z-10`}
         }
      }
   }
   .slick-track {
...
const Slider = ({ slideIndex }) => {
  ...
  return (
    <StyledSlider className="md:w-[80%] mx-auto overflow-hidden bg-transparent">
      <div className="container p-0 ">
        <Slick {...sliderSettings} ref={slider}>
          <div className="md:w-[80%] overflow-hidden mx-auto">
