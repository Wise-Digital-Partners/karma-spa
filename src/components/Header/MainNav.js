...
const StyledMainNav = styled.nav`
  ${({ headerHasBorder }) =>
    headerHasBorder ? tw`border-b border-solid border-white border-opacity-25` : null};
  ...
  @media (max-width: 1023px) {
    ...
    ${({ headerStyle }) =>
      headerStyle === "overlap" ? tw`border-b border-solid border-white border-opacity-25` : null};
  }
  &[data-fixed="true"] {
  ...
  const data = useStaticQuery(graphql`
    {
      ...
      massageServicesCarlsbad: file(
        relativePath: { eq: "repeating/Carlsbad Massage Services - Card.jpg" }
      ) {
        childImageSharp {
          fluid(maxWidth: 504, quality: 100) {
            ...GatsbyImageSharpFluid_withWebp
      ...
      specialPackagesCarlsbad: file(
        relativePath: { eq: "repeating/Carlsbad Special Packages - Card.jpg" }
      ) {
        childImageSharp {
          fluid(maxWidth: 504, quality: 100) {
            ...GatsbyImageSharpFluid_withWebp
      ...
      skinCareServicesCarlsbad: file(
        relativePath: { eq: "repeating/Carlsbad Skin Care - Card.jpg" }
      ) {
        childImageSharp {
          fluid(maxWidth: 504, quality: 100) {
            ...GatsbyImageSharpFluid_withWebp
      ...
      <div className="container flex items-center">
        ...
        <div className="flex items-center justify-end flex-auto">
          <ul
            ...
            className="hidden lg:flex lg:items-center lg:justify-end mr-10 space-x-10"
          >
            <li
              className={`is-mega-menu-parent navigation-item static group ${
                megaMenuHovering1 ? "active" : ""
              }`}
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-4 gap-y-12 lg:gap-y-0 lg:gap-x-10">
                    <div className="group relative">
                      ...
                      <p className="text-small mb-0">
                        No matter your indulgence, we have a massage for you.
                      </p>
                    ...
                    <div className="group relative">
                      ...
                      <p className="text-small mb-0">
                        Our popular packages will pamper you with great value.
                      </p>
                    ...
                    <div className="group relative">
                      ...
                      <p className="text-small mb-0">
                        Facials, waxing, scrubs and saunas for the ultimate glow-up.
                      </p>
            ...
            <li
              className={`is-submenu-parent navigation-item relative group ${
                subMenuHovering1 ? "active" : ""
              }`}
            ...
            >
              ...
              <ul className="text-center mb-12">
                <li className="font-heading font-medium mb-5">
                  <a
                    className="gtm-phone-number text-gray-700 no-underline"
